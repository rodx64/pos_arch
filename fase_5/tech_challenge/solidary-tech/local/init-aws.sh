...
if ! awslocal dynamodb describe-table --table-name VolunteerTable >/dev/null 2>&1; then
  ...
  echo "✅ Tabela DynamoDB criada: VolunteerTable"
else
  echo "⚠️ Tabela DynamoDB já existe: VolunteerTable"
fi
